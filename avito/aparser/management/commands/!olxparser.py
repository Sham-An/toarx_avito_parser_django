...
def parse_xml(url):
    ...
    path = './/div[@elementtiming="bx.catalog.container"]//div[@data-marker="item"]' #//meta[@content]'
    path_title1 = './/div[@elementtiming="bx.catalog.container"]//div[@data-item-id]//div[@class = "iva-item-descriptionStep-QGE8Y"]//text()'
    #path_title = './/div[@elementtiming="bx.catalog.container"]//div[@data-item-id]//div[substring(@class,1,13) ="iva-item-desc"]//text()'
